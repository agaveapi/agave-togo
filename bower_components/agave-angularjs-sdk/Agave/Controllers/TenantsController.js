...
'use strict';
angular.module('agave.sdk').factory('TenantsController', ['$q', 'Configuration', 'HttpClient', 'APIHelper', function ($q, Configuration, HttpClient, APIHelper) {
    return {
        /**
        ...
        listTenants: function (limit, offset, queryParameters) {
            ...
            var baseUri = 'https://agave-auth.solveij.com';
